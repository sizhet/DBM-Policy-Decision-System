...
## 1. Poster Layout（结构蓝图）


# ![PDS-Canonical-Poster—One-Page-Paradigm.png](../assets/PDS-Canonical-Poster—One-Page-Paradigm.png)

## 2. Poster Tagline（主标题句）

> **PDS: Intelligence as Policy-Controlled Traversal over Future Space**

中文：

> **PDS：在策略塑形的未来空间中的受控智能演化**

## 3. Three Core Messages（三个核心信息）
